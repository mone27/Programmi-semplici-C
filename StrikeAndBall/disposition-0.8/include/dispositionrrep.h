...
/* headers of basic predefined types of dispositions */

#ifndef _DISPOSITIONRREP_H_
#define _DISPOSITIONRREP_H_
...
newDispRRepFunction newDispositionRRep[] = {
	newPermutationRRep, newCombinationRRep
};
